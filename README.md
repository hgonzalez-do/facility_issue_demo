...
Not wired up yet — see the deploy plan. Target shape: `./deploy.sh` from a
fresh clone with a filled-in `.env`, producing App Platform + Managed Postgres +
a webhook trigger + a cron trigger, on any DigitalOcean team.
